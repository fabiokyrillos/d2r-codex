...
export const ptBR: Dictionary = {
  ...
  skills: {
    ...
    ariaNode: "{skill}, nível {level}, {tree}, {state}.",
    ariaNodeBuild: "{skill}, nível {level}, {tree}, {state}, {points}.",
    stateLocked: "Bloqueada",
    stateAvailable: "Disponível",
    announceSelected: "{skill} selecionada. {state}.",
    treesLabel: "Árvores",
    treePoints: "{points} de {max} pontos nesta árvore",
    treePointsShort: "{points}/{max}",
    treeThemeSummary: "Sobre esta árvore",
    levelLabel: "Meu nível",
    levelHelp: "Só marca o que ainda está bloqueado. Não altera mais nada.",
    levelClear: "Limpar",
    levelClearLabel: "Limpar meu nível",
    levelInvalid: "Um número inteiro de 1 a 99.",
    legendLocked: "Bloqueada: moldura tracejada e cadeado — acima do seu nível.",
    legendAvailable: "Disponível: moldura simples.",
    legendInvested: "Investida: moldura ember e os pontos no canto.",
    legendMaxed: "Maximizada: moldura ember, anel interno e uma estrela.",
    legendOptional: "Opcional: a pílula dos pontos é tracejada — esta build deixa a escolha com você.",
    legendConnector:
      "Uma linha liga o pré-requisito à skill que o exige; acende na skill selecionada.",
    legendKeyboard:
      "As setas percorrem a fileira e a coluna; na borda, continuam para a fileira vizinha. Home e End vão à primeira e à última skill.",
    unlocksNone: "Nenhuma skill exige esta.",
    synergiesNone: "Sem sinergias.",
    panelPoints: "Pontos nesta build: {points}",
    placeholderNote: "O símbolo é um placeholder por tipo e elemento até chegar o conjunto de ícones.",
