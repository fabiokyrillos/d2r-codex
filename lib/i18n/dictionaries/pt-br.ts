...
export const ptBR: Dictionary = {
  ...
  skills: {
    ...
    ariaBuild: "{skill}, nível {level}, {tree}, {points} pontos, {classification}.",
    ariaBuildOne: "{skill}, nível {level}, {tree}, 1 ponto, {classification}.",
    ...
    legendFlex: "mais {points} opcionais",
    eyebrow: "Skill",
    atAGlance: "Resumo",
    ...
    synergiesNote: "A identidade das sinergias é consenso publicado da comunidade, não dado do jogo. As magnitudes são verificadas.",
