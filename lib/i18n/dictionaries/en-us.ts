...
export const enUS = {
  ...
  builds: {
    ...
    packages: "Choosing the rest of the plan",
    packagesDescription:
      "The core above is mandatory. What follows spends the points it leaves — costed, closed, and with the alternatives marked as alternatives.",
    ...
    packageGear: "What changes in your gear",
  ...
  skills: {
    ...
    effectRangeNote:
      "The game states where this starts and the ceiling it climbs toward, but not the curve between them — that lives in the engine rather than in the data files this site reads, so no per-level table is printed for it.",
  ...
  availability: {
    ...
    description:
      "Making a thing, getting hold of one and using it are three different permissions, and for one runeword in the game all three currently differ. This table answers them for every mode, rather than picking a side — because a mode where the item works is not automatically a mode where you can come by one.",
    modeLadder: "Ladder",
    modeNonLadderOnline: "Non-Ladder, online",
    modeOffline: "Offline",
    statusCraftable: "Can be made",
    statusUsable: "Can be worn, not made",
    statusUnobtainable: "Would work, but you cannot get one",
