...
export const mechanicsPtBr: Overlay<MechanicCopy> = {
  ...
  curses: {
    ...
    keyFacts: [
      ...
      "**Amplify Damage e Decrepify não são dois graus da mesma maldição.** As duas quebram uma imunidade física rasa, mas a regra de um quinto deixa o Amplify Damage com 20 pontos contra os 10 do Decrepify — então o Amplify Damage vai o dobro de fundo, e uma imunidade funda o bastante sobrevive às duas.",
    ...
    body: [
      ...
      },
      {
        ...
        rows: [
          ["Amplify Damage", "−100 de resistência a dano físico", "−20, o que quebra de 100% até 119%"],
          ["Decrepify", "−50 de resistência a dano físico", "−10, o que quebra de 100% até 109% e para aí"],
      ...
      },
      {
        type: "callout",
        variant: "info",
        title: "Contra um imune, as duas maldições alcançam profundidades diferentes",
        text: "As duas quebram imunidade física; elas não vão igualmente fundo numa. Depois do corte de um quinto o Amplify Damage vale 20 pontos e o Decrepify vale 10, então **o Amplify Damage quebra de 100% até 119%, e o Decrepify quebra de 100% até 109%**. Um monstro em 110% é o primeiro que separa os dois, e um monstro em 120% é imune aos dois. **Leve o Amplify Damage quando o trabalho for quebrar uma imunidade** — ele penetra o dobro, e é o único dos dois em que dá para confiar sem saber o número exato do monstro. **Os dois não são intercambiáveis, e nenhum é uma versão estritamente melhor do outro.** Em todo o resto eles são uma troca de verdade: o Amplify dobra o seu dano contra um alvo que não resiste, enquanto o Decrepify o multiplica por 1,5 e ainda desacelera, enfraquece e trava o alvo.\n\n**Quebrar uma imunidade não é o mesmo que vencê-la.** Um monstro em exatamente 100% termina em 80% com Amplify Damage e em 90% com Decrepify — deixa de ser imune, e continua absorvendo quatro quintos ou nove décimos do golpe. O que a quebra compra é o dano passar a entrar.",
      },
      ...
      },
      {
        ...
        items: [
          ...
          "**Um imune a físico** — Amplify Damage primeiro, porque alcança o dobro de fundo. O corte dele vira 20 pontos e o do Decrepify vira 10, então o Decrepify quebra sim um que esteja entre 100% e 109%, e nada além disso.",
