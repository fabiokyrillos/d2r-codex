...
export const mechanics: MechanicArticle[] = [
  ...
  },
  {
    ...
    keyFacts: [
      ...
      "**Amplify Damage and Decrepify are not two grades of the same curse.** Both break a shallow physical immunity, but the one-fifth rule leaves Amplify Damage 20 points against Decrepify's 10 — so Amplify Damage reaches twice as deep, and a deep enough immunity survives either.",
    ...
    body: [
      ...
      },
      {
        ...
        rows: [
          ["Amplify Damage", "−100 physical damage resistance", "−20, which breaks anything from 100% up to 119%"],
          ["Decrepify", "−50 physical damage resistance", "−10, which breaks 100% up to 109% and stops there"],
      ...
      },
      {
        type: "callout",
        variant: "info",
        title: "Against an immune the two curses reach different depths",
        text: "Both curses break a physical immunity; they do not reach equally far into one. After the one-fifth cut Amplify Damage is worth 20 points and Decrepify 10, so **Amplify Damage breaks anything from 100% up to 119%, and Decrepify breaks 100% up to 109%**. A monster at 110% is the first that separates them, and a monster at 120% is immune to both. **Bring Amplify Damage when the job is breaking an immunity** — it penetrates twice as deep, and it is the only one of the two that can be relied on without knowing the monster's exact number. **The two are not interchangeable and neither is a strictly better version of the other.** Everywhere else they are a real trade: Amplify doubles your damage against an unresisting target, while Decrepify multiplies it by 1.5 and slows, weakens and hobbles the target as well.\n\n**Breaking an immunity is not the same as beating it.** A monster at exactly 100% ends at 80% under Amplify Damage and 90% under Decrepify — no longer immune, and still absorbing four fifths or nine tenths of the hit. What the break buys is that damage lands at all.",
      },
      ...
      },
      {
        ...
        items: [
          ...
          "**A physical immune** — Amplify Damage first, because it reaches twice as deep. Its cut becomes 20 points and Decrepify's becomes 10, so Decrepify does break one sitting at 100% to 109% and nothing beyond that.",
