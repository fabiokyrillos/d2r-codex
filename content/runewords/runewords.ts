...
export const runewords: Runeword[] = [
  ...
  },
  {
    ...
    confidence: "verified",
    notes:
      "The stat lines are verified against `json/runes.json` at the pinned commit. `oskill Abyss` puts a Warlock capstone on any class that can hold a dagger, and it is one of a handful on this site that grant a skill across classes — Enigma, Call to Arms, Beast, Passion, Harmony and Kingslayer all do it too, and Passion and Call to Arms both hand over a level-30 skill, so this is not the only capstone on the list either. What it is is the only one that grants a Warlock skill. The charge line reads count-then-level like every other: `min=35 max=4` is thirty-five charges of a level 4 Decrepify.",
  },
  {
    slug: "vigilance",
    name: "Vigilance",
