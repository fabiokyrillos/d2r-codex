...
export const uniques: UniqueItem[] = [
  ...
  },
  {
    ...
    name: "Lacerator",
    summary:
      "A thrown axe that amplifies what it hits. 33% to cast Amplify Damage on striking, Open Wounds, and Prevent Monster Heal.",
    quality: "unique",
    base: "Winged Axe",
    category: "throwing",
    tier: "elite",
    ...
    stats: [
      { text: "33% Chance to cast level 3 Amplify Damage on striking", notable: true },
      { text: "+150-210% Enhanced Damage", variable: true, notable: true },
      ...
      { text: "Replenishes quantity (1 in 25 seconds)" },
    ],
    drop: {
      summary: "Area level 76+. Hell only.",
      minMonsterLevel: 76,
      tradeability: "uncommon",
      confidence: "verified",
    },
    notes:
      "Amplify Damage on striking halves a target's physical resistance, which is worth more to a throwing build than any raw damage line — it applies to the mercenary's hits too. The flee chance is the reason it is usually the off-hand rather than the main throw: 64% is high enough to scatter a pack you were about to clear.",
    confidence: "verified",
  },

  {
    ...
    name: "Warshrike",
    summary:
      "The highest damage roll of the thrown weapons, with 50% Piercing Attack and 50% Deadly Strike.",
    quality: "unique",
    base: "Winged Knife",
    category: "throwing",
    tier: "elite",
    ...
    stats: [
      { text: "+200-250% Enhanced Damage", variable: true, notable: true },
      { text: "50% Deadly Strike", notable: true },
      { text: "50% Piercing Attack", notable: true },
      { text: "30% Increased Attack Speed" },
      { text: "25% Chance to cast level 9 Nova on striking" },
      { text: "Replenishes quantity (1 in 30 seconds)" },
    ],
    drop: {
      summary: "Area level 83+. Hell only, and one of the higher-level uniques in the game.",
      minMonsterLevel: 83,
      tradeability: "rare",
      confidence: "verified",
    },
    notes:
      "45 Strength against Lacerator's 96, and 142 Dexterity against 122. The stat split is the choice: a Winged Knife is the cheap base to *wear* and the expensive one to *hit* with.",
    confidence: "verified",
  },

  {
    ...
    name: "Gimmershred",
    summary:
      "Three elements on a thrown axe — up to 483 fire, 397 cold and 501 lightning — on top of its physical damage.",
    quality: "unique",
    base: "Flying Axe",
    category: "throwing",
    tier: "elite",
    ...
    stats: [
      { text: "Adds 218-483 Fire Damage", variable: true, notable: true },
      { text: "Adds 29-501 Lightning Damage", variable: true, notable: true },
      { text: "Adds 176-397 Cold Damage", variable: true, notable: true },
      { text: "+160-210% Enhanced Damage", variable: true },
      { text: "30% Increased Attack Speed" },
      { text: "Increased Stack Size" },
    ],
    drop: {
      summary: "Area level 78+. Hell only.",
      minMonsterLevel: 78,
      tradeability: "uncommon",
      confidence: "verified",
    },
    notes:
      "The elemental damage is added, not converted, so it lands alongside the physical rather than instead of it — which is why a physical immune still costs this weapon most of its output. It carries no Replenishes Quantity, and `Increased Stack Size` is not a substitute: a bigger stack runs out later, it does not refill.",
    confidence: "verified",
  },
];
