...
export const barbarianJourneyPtBr: JourneyCopy = {
  ...
  overview: [
    "**O problema de evolução do Barbarian não é dano, é ter que apostar vinte pontos num palpite.** Uma mastery só funciona com uma família de arma, existem seis delas, e a arma que dá para comprar no nível 3 não é a arma que você vai estar segurando no Nightmare. Toda outra classe deste site faz respec porque a skill de evolução não é a skill de endgame; esta faz respec porque a *arma* de evolução não é a arma de endgame.",
  ...
  stages: {
    ...
    "bar-act-2-normal": {
      ...
      actions: [
        ...
        "**Faça duas armas Steel no nível 13**, uma para cada mão. Tir + El em qualquer espada, machado ou maça de 2 sockets: +25% de velocidade de ataque, +20% de dano aprimorado, +50 de attack rating e 50% de Open Wounds. Duas delas são o dano inteiro desta etapa.",
    ...
    "bar-hell": {
      ...
      actions: [
        ...
        "**Whirlwind** não precisa de mais nada desta rota. Maximize a mastery, maximize o Berserk, e a página de build leva de 86 a 110.",
        "**Frenzy e Double Throw** são as duas builds que esta rota alcança sem respec nenhum, porque a corrente de pré-requisito delas é a que você evoluiu por dentro: Bash alimenta Double Swing a 10% por ponto, e Double Swing alimenta tanto Frenzy quanto Double Throw a 8%. As duas precisam de duas armas.",
        "**Berserk** e **Leap Attack** precisam cada um do token da Den of Evil do Hell. O Berserk quer Howl e Battle Orders maximizados e Find Item por cima; o Leap Attack quer Leap maximizado, que é a única sinergia dele e algo a que esta rota só deu um ponto.",
        "**War Cry** é o único destino que esta rota não serve. As sinergias dele são Howl, Taunt e Battle Cry a 6% por ponto cada, e ele não precisa de arma e portanto de mastery nenhuma — então quem for para lá deveria fazer respec ainda no Nightmare em vez de seguir o plano de mastery acima.",
      ],
      gearTargets: [
