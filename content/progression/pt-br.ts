...
export const journeysPtBr: Overlay<JourneyCopy> = {
  ...
  necromancer: {
    ...
    overview: [
      ...
      "**O Decrepify é destravado no nível 24, não no 30.** O Summon Resist também. Quando você chegar no 24 vai ter quatro pontos de skill de quest guardados da Den of Evil, do Radament e do Izual, então pegar os dois na mesma sessão é realista em vez de plano para depois. O Lower Resist é a skill que chega no 30, e esta rota não a pega.",
    ...
    stages: {
      ...
      "nec-act-5-normal": {
        name: "Vinte e quatro, e as duas skills de uma vez",
        summary: "Níveis 24-29. Summon Resist e Decrepify destravam os dois aqui, e você vai ter pontos de quest guardados para os dois.",
        location: "Ato 5 — Harrogath até a Worldstone Chamber",
        ...
        skillPoints: [
          ...
          "O nível 24 também abre o **Decrepify**, e a esta altura você tem quatro pontos de skill de quest da Den of Evil, do Radament e do Izual — então pegue os dois em vez de escolher. O Decrepify são −50% de movimento, velocidade de ataque, dano causado e resistência física, tudo de uma vez.",
      ...
      "nec-nightmare": {
        ...
        actions: [
          ...
          "**Imunes a físico começam a aparecer aqui, e o Amplify Damage é a resposta.** Ele corta 100 pontos de resistência a dano físico, e contra um monstro parado em exatamente 100% a regra de imunidade deixa −20 — que ainda quebra. Os −50 do Decrepify viram −10 no mesmo monstro e não quebram. É a única situação em que as duas maldições não são intercambiáveis.",
        ],
      ...
      "nec-hell": {
        ...
        actions: [
          ...
          "**A imunidade física é o problema e você tem duas respostas para ela.** O Amplify Damage a quebra de vez para os esqueletos; a metade de fogo do Corpse Explosion entra num imune a físico independentemente de qualquer maldição. O Decrepify não quebra imunidade física — o corte dele já é metade e é reduzido a um quinto contra um imune — então ele continua sendo a maldição de sobrevivência em vez de virar a resposta à imunidade.",
