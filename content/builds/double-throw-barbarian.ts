...
export const doubleThrowBarbarian: Build = {
  ...
  gearSets: [
    ...
    },
    {
      ...
      slots: [
        ...
        { slot: "gloves", picks: [{ ref: { kind: "unique", slug: "draculs-grasp" }, why: "Life Tap on striking works from a thrown weapon, which is the sort of thing this build gets for free and a melee character pays for with proximity." }] },
  ...
  farming: [
    ...
    { area: "chaos-sanctuary", difficulty: "hell", why: "The seal bosses die to single-target damage at range, and the Oblivion Knights cannot curse what they cannot reach. One of the safest places for this build in the game.", minTier: "budget", rating: 4 },
    { area: "worldstone-keep", difficulty: "hell", why: "Area level 85 and dense, and the long corridors suit pierce. Density is not this build's strength, but the layout is.", minTier: "early-hell", rating: 4 },
