...
export const warlockBuildsPtBr: Overlay<BuildCopy> = {
  ...
  "apocalypse-warlock": {
    ...
    statPlan: {
      ...
      notes: [
        "**O requisito de Strength é o plano de atributos.** A melhor mão secundária da classe, um Blasphemous Grimoire, pede **106 de Strength** contra uma base de 15. A maioria dos casters deste site é orientada a não tocar na stat, e as exceções estão logo ao lado: a Enchant Sorceress recebe 80, e duas das outras três páginas de Warlock já citam 82 e 95. O que torna esta a maior é o slot, e não o número — os 80 da Sorceress compram uma arma, e cada uma dessas cifras de Warlock compra uma mão secundária.",
