...
export const berserkBarbarian: Build = {
  ...
  gearSets: [
    ...
    },
    {
      ...
      levelRange: [40, 65],
      slots: [
        { slot: "weapon", picks: [{ ref: { kind: "runeword", slug: "passion" }, why: "**+1 to Berserk** on top of +25% attack speed at level 43 — a runeword that names the build's own skill, in any 4-socket weapon.", alternatives: [{ label: "Oath (`oath`) in a 4-socket sword — Balrog Blade or Cryptic Sword", why: "Level 49: +210-340% enhanced damage, and enhanced damage is converted along with the rest, so it is not wasted on a magic attack." }, { ref: { kind: "runeword", slug: "kingslayer" }, why: "Level 53, −25% target defence from the weapon slot." }] }] },
