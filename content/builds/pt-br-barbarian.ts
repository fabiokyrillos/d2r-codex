...
export const barbarianBuildsPtBr: Overlay<BuildCopy> = {
  ...
  "whirlwind-barbarian": {
    ...
    skillNotes: {
      ...
      "blade-mastery":
        "+28% de dano e 5% por nível, +40% de attack rating e 8% por nível, e uma chance de crítico subindo em direção a 35% — dez pontos acima do teto do Claw Mastery da Assassin. **Troque por qual mastery a sua arma de fato é.** Ela é presa ao tipo de item que o jogo chama de Swords and Knives; uma Grief Phase Blade é espada e serve, uma Grief Berserker Axe não é e pede Axe Mastery.",
      "battle-orders":
