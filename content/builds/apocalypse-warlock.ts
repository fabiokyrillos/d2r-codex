...
export const apocalypseWarlock: Build = {
  ...
  stats: {
    ...
    notes: [
      "**The Strength requirement is the stat plan.** A Blasphemous Grimoire asks **106 Strength** against a class base of 15 — ninety-one points that would otherwise be 273 life. Most casters on this site are told to leave the stat alone, and the exceptions are close by: the Enchant Sorceress is told 80, and two of the other three Warlock pages already name 82 and 95. What makes this one the largest is the slot rather than the number — the Sorceress's 80 buys a weapon, and every one of those Warlock figures buys an off-hand.",
