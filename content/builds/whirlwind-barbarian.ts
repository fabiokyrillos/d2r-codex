...
export const whirlwindBarbarian: Build = {
  ...
  stats: {
    strength: "Enough for your gear and not one point more — and the number swings hugely with the weapon, which is exactly why it is decided before the respec rather than after. A Grief Phase Blade asks 25 and a Cryptic Sword 99; a Balrog Blade asks 185, dual-wielded or not. Past the weapon the body armour sets the number, and a Lionheart or a Fortitude on a lighter base moves it.",
  ...
  farming: [
    ...
    { area: "worldstone-keep", difficulty: "hell", why: "Dense, area level 85, and the run to Baal is the standard endgame loop. A whirl across a Worldstone pack is the build at its best — but the area records physical immunity alongside fire, lightning and cold, so the Berserk package or a Bone Break is what keeps the spin working here.", minTier: "budget", rating: 4 },
    { area: "chaos-sanctuary", difficulty: "hell", why: "Dense and lucrative, but the seal bosses and the Oblivion Knights punish a character who has to stand in melee. **It records physical immunity**, so bring the Berserk package — the spin alone stalls on the packs it cannot hurt.", minTier: "budget", rating: 3 },
