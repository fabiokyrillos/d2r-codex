...
export const whirlwindBarbarian: Build = {
  ...
  gearSets: [
    ...
    },
    {
      ...
      levelRange: [40, 65],
      slots: [
        { slot: "weapon", picks: [{ label: "Oath (`oath`) in a 4-socket sword — Balrog Blade, Highland Blade or Cryptic Sword", why: "Shael Pul Mal Lum at level 49: +210-340% enhanced damage, 50% increased attack speed once Shael's contribution is counted, and Prevent Monster Heal. It is legal in axes and maces as well and nobody plays those — the guides put it on swords and take Blade Mastery for it.", alternatives: [{ ref: { kind: "runeword", slug: "passion" }, why: "Level 43, four sockets, +1 to Berserk and +25% attack speed — the cheaper stand-in, and it fits whichever mastery you settled on." }, { ref: { kind: "runeword", slug: "kingslayer" }, why: "Level 53, and its −25% target defence does the same job as Battle Cry from the weapon slot." }] }] },
