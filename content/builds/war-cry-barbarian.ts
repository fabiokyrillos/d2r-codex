  ...
  gearSets: [
    ...
    },
    {
      ...
      slots: [
        ...
        { slot: "belt", picks: [{ ref: { kind: "unique", slug: "arachnid-mesh" }, why: "**+1 to all skills and +20% Faster Cast Rate** at level 80 — no other belt catalogued on this site offers either line, and this build wants both." }, { ref: { kind: "unique", slug: "verdungos-hearty-cord" }, why: "Damage reduction and Vitality instead, when survivability is the problem." }] },
