...
export const enchantSorceress: Build = {
  ...
  skills: [
    ...
    { skill: "fire-ball", points: 1, role: "prerequisite", note: "Enchant's prerequisite, and a usable spell for the rare thing your bolts cannot reach." },
    { skill: "meteor", points: 1, role: "prerequisite", note: "Fire Mastery's prerequisite. One point, and it is worth binding anyway." },
    ...
    { skill: "inferno", points: 1, role: "prerequisite" },
    { skill: "fire-wall", points: 1, role: "utility", note: "A cheap second fire source for the rare corridor where the bolts are not enough." },
  ],
  flexPoints: [
