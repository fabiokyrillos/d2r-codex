...
export const lightningTrapsin: Build = {
  ...
  flexPoints: [
    ...
    "**Do not split the twenty across two packages.** Fade at ten is half the physical damage reduction, which is flat at a point per level; Fire Blast at ten is a bomb that does not kill the immune pack you took it for. Each of the three is worth taking whole and none is worth half.",
