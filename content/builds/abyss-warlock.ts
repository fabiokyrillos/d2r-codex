  ...
  gearSets: [
    ...
    },
    {
      ...
      slots: [
        ...
        { slot: "amulet", picks: [{ label: "Entropy Locket", why: "**+5-10% to Magic Skill Damage** and 4-19% chance to cast Miasma Chain on striking. The first item in the game that multiplies magic damage, and it is a level 54 amulet.", lookFor: ["+10% to Magic Skill Damage", "+40 Lightning Resist"] }] },
    ...
    },
    {
      ...
      slots: [
        ...
        { slot: "body", picks: [{ ref: { kind: "runeword", slug: "authority" }, why: "Hel Shael Ral: +2 to Warlock skills and a chance to cast Miasma Chain when struck, which on this build is your own damage type coming back at whatever hit you." }] },
