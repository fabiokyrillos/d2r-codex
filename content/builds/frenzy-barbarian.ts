...
export const frenzyBarbarian: Build = {
  ...
  gearSets: [
    ...
    },
    {
      ...
      levelRange: [40, 65],
      slots: [
        { slot: "weapon", picks: [{ ref: { kind: "runeword", slug: "passion" }, why: "Level 43 in any 4-socket weapon: +25% attack speed and +1 to Berserk, which on this build is +1% Frenzy damage converted to magic as well as a better emergency button.", alternatives: [{ ref: { kind: "runeword", slug: "kingslayer" }, why: "Level 53, and its −25% target defence answers this build's attack-rating problem from the weapon slot." }, { label: "Oath (`oath`) in a 4-socket sword — Balrog Blade or Cryptic Sword", why: "Level 49: +210-340% enhanced damage and 50% attack speed once Shael's contribution is counted. Legal in axes and maces too; the guides put it on swords and take Blade Mastery for it." }] }] },
