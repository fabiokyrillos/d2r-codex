  ...
  gearSets: [
    ...
    },
    {
      ...
      slots: [
        ...
        { slot: "gloves", picks: [{ label: "Crafted Blood gloves with 20% Increased Attack Speed and life stolen per hit", why: "Both stats compound with the stack. **Dracul's Grasp is the goal and it requires level 76**, which is past this tier's band — it arrives in the next one." }] },
