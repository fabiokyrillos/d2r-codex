...
export const summonerNecromancer: Build = {
  ...
  skills: [
    ...
    },
    {
      ...
      points: 1,
      role: "utility",
      note: "**−100 to physical damage resistance: the largest physical multiplier in the game, and one point is the whole of it.** It also breaks a 100% physical immunity, where Decrepify's −50 becomes −10 against one and does not. Extra points buy radius and duration only.",
    },
    {
      skill: "clay-golem",
      points: 1,
  ...
  flexPoints: [
    ...
    "**Bone Wall and Bone Prison**, which are Bone Armor's two synergies. Twenty points across them turns a token shield into several hundred absorbed damage, and Bone Prison is a wall you can drop between yourself and something the army has not reached.",
